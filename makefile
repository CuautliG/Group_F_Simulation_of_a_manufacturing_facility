...
test: test\main_test.o test\read_config_test.o test\read_data_test.o test\work_flow_test.o test\export_files_test.o test\common_functions_test.o
	$(CC) -g -o bin/Group_F_Simulation_of_a_manufacturing_facility build/main_test.o build/read_config_test.o build/read_data_test.o build/work_flow_test.o build/export_files_test.o build/common_functions_test.o
