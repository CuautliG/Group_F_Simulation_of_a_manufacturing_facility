...
test: test\main_test.o test\read_config_test.o test\read_data_test.o test\work_flow_test.o test\export_files_test.o test\common_functions_test.o
	$(CC) -g -o test\bin/Group_F_Simulation_of_a_manufacturing_facility test\build/main_test.o test\build/read_config_test.o test\build/read_data_test.o test\build/work_flow_test.o test\build/export_files_test.o build/common_functions_test.o
...
test\common_functions_test.o : test\src\common_functions_test_test.c
